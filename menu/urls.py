...
urlpatterns = [
    ...
    path("administrador/proveedores/", views.listar_proveedores, name="listar_proveedores"),
    path("administrador/proveedores/crear/", views.crear_proveedor, name="crear_proveedor"),
    path("administrador/proveedores/<int:proveedor_id>/editar/", views.editar_proveedor, name="editar_proveedor"),
    path("administrador/proveedores/<int:proveedor_id>/eliminar/", views.eliminar_proveedor, name="eliminar_proveedor"),
